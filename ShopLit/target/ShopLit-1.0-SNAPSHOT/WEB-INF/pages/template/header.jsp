...
<head>
    ...
    <link rel="icon" href="<c:url value="/resources/ss.jpg"/>">
...
<body>
<jsp:useBean id="shoppingCart" class="com.paripa.by.model.ShoppingCart" scope="session"/>
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<c:url value="/"/>">litShop</a>
        </div>
